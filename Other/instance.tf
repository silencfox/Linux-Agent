...
resource "azurerm_virtual_machine_extension" "main" {
  ...
  settings = <<SETTINGS
    {
        "commandToExecute": "cd /home/trainer/ && wget https://vstsagentpackage.azureedge.net/agent/3.232.1/vsts-agent-linux-x64-3.232.1.tar.gz && mkdir myagent && cd myagent && tar zxvf /home/trainer/vsts-agent-linux-x64-2.190.0.tar.gz && chmod 777 /home/trainer/myagent"
    }
SETTINGS
